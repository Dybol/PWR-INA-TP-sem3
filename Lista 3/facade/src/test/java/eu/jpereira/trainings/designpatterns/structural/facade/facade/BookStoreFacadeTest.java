...
import eu.jpereira.trainings.designpatterns.structural.facade.DefaultFacade;
...
public class BookStoreFacadeTest extends AbstractClientTest {
	...
	//		BookstoreFacade bookstoreFacade = Mockito.mock(BookstoreFacade.class);
		DefaultFacade facade = new DefaultFacade();
