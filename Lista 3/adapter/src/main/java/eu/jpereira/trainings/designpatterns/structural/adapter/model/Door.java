...
public interface Door {
	 ...
	 */
	void open(String code) throws IncorrectDoorCodeException, CannotUnlockDoorException;
	...
	void changeCode(String oldCode, String newCode, String newCodeConfirmation)
			throws IncorrectDoorCodeException, CodeMismatchException, CannotUnlockDoorException, CannotChangeCodeForUnlockedDoor, CannotChangeStateOfLockedDoor;
	 ...
	 */
	boolean testCode(String code) throws IncorrectDoorCodeException, CannotUnlockDoorException, CannotChangeStateOfLockedDoor;
